...
execute_process(
  COMMAND "D:/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "v1.3.7"
  WORKING_DIRECTORY "D:/ALL_FAC/clion_fac/Battle-Arena/cmake-build-debug/_deps/vorbis-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/ALL_FAC/clion_fac/Battle-Arena/cmake-build-debug/_deps/vorbis-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/ALL_FAC/clion_fac/Battle-Arena/cmake-build-debug/_deps/vorbis-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
